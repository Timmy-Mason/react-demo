        ...
        return (
            <div className="game">
                ...
                <LocaleProvider locale={zhCN}>
                    <Pagination size="medium" pageSizeOptions={this.state.pageSizeOptions}
                                onChange={current => this.getPages(current, this.state.pageSize)}
                                onShowSizeChange={pageSize => this.getPagesSize(this.state.current, pageSize)}
                                total={this.state.gameAmount} showSizeChanger showQuickJumper/>
                </LocaleProvider>
